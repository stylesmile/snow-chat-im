...
每次接收并实现需求后，**必须**输出技术文档到 `docs/` 目录，确保需求可追溯、可复现。
...
```
docs/
├── {YYYY-MM-DD}_{需求简称}.md    # 例如：2026-07-20_消息回执系统.md
├── {YYYY-MM-DD}_{需求简称}.md
└── ...
```
...
```
docs/
├── 2026-07-20_消息回执系统.md
├── 2026-07-20_群组创建功能.md
├── 2026-07-20_导航栏未读数.md
└── ...
```
